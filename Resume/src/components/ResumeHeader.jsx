...
export function ResumeHeader({ personal }) {
  return (
    <header className="resume-header">
      ...
      <div className="contact-row">
        ...
        {personal.phone && personal.email && <span className="sep">&bull;</span>}
        ...
        {personal.email && personal.location && <span className="sep">&bull;</span>}
        ...
        {personal.leetcode && (
          <>
            ...
            <a href={personal.leetcode} target="_blank" rel="noreferrer" className="contact-item">
              ...
              {personal.leetcodeDisplay || 'LeetCode'}
            </a>
          </>
        )}
        ...
        {personal.gfg && (
          <>
            ...
            <a href={personal.gfg} target="_blank" rel="noreferrer" className="contact-item">
              ...
              {personal.gfgDisplay || 'GeeksforGeeks'}
            </a>
          </>
        )}
      </div>
